...
# ). Make sure your program works on two lists of different sizes. Write this in one line of Python using
...
common_list = []
common_list = list(set([i for i in a if i in b and i not in common_list]))
